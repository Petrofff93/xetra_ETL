...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.s3_access_key = "AWS_ACCES_KEY_ID"
    ...
    def test_list_files_in_prefix_wrong_prefix(self):
        """
        Tests the list_files_in_prefix method in case
        of a wrong or not existing prefix
        """
        # Expected results
    ...
    def test_read_csv_to_df_ok(self):
        ...
        with self.assertLogs() as logm:
            ...
            # Log test after method executes
