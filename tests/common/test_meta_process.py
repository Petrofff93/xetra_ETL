...
class TestMetaProcessMethods(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.s3_bucket_meta = S3BucketConnector(self.s3_access_key, self.s3_secret_key, self.s3_endpoint_url,
                                                self.s3_bucket_name)
    ...
    def test_update_meta_file_meta_file_ok(self):
        ...
        """
        # Expected results
        date_list_old = ['2022-10-16', '2022-10-17']
        date_list_new = ['2022-10-12', '2022-10-13']
